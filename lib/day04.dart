...
int solveA(Iterable<String> input) => Passport.parseInput(input)
    .where((passport) => passport.isValidPartOne)
    .length;

int solveB(Iterable<String> input) => Passport.parseInput(input)
